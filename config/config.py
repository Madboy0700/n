...
API_ID = int(getenv("API_ID", "9049923"))

API_HASH = getenv("API_HASH", "b729ced11a14eca594347cd9f0d510e8")

## Get it from @Botfather in Telegram.

BOT_TOKEN = getenv("BOT_TOKEN", "6757500151:AAG7SyXcVIwGWqOEIANaAOjx6IlXMmy3qDU")
